...
public class Entities
{
	...
	private static <T extends Entity> RegistrySupplier<EntityType<T>> register(Identifier resourceLocation, EntityType.Builder<T> builder)
	{
	...
	{
		return Identifier.fromNamespaceAndPath(ParchedAndBogged.MOD_ID, name);
	}
