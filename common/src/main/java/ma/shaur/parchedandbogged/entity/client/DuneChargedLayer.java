...
{
	public static final ModelLayerLocation DUNE_WIND = new ModelLayerLocation(Identifier.fromNamespaceAndPath(ParchedAndBogged.MOD_ID, "wind"), "main");
	private static final Identifier DUNE_WIND_LOCATION = Identifier.fromNamespaceAndPath(ParchedAndBogged.MOD_ID, "textures/entity/dune/dune_wind.png");
	...
	public void submit(PoseStack poseStack, SubmitNodeCollector submitNodeCollector, int i, DuneRenderState entityRenderState, float f, float g)
	{
		...
		RenderType renderType = RenderTypes.breezeWind(DUNE_WIND_LOCATION, xOffset(entityRenderState.ageInTicks) % 1.0F, 0.0F);
